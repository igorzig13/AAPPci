  ...
  <div class="row">
    <div class="col l6 s12">
      <div class="icon-block">
        ...
        <div class="card horizontal teal lighten-5">
          <div class="card-image">
            <img src="<?php echo base_url('assets/images/atraso.png') ?>">
          </div>
          <div class="card-stacked">
            <div class="card-content">
              <span class="card-title">Lista de Clientes em atraso</span><br>
              Clique para conferir a relação completa de clientes que estão em atraso.
            </div>
            <div class="card-action">
              <a class=" blue-text zLink right" href="<?php echo base_url("index.php/Cliente/######") ?>">Ver clientes em atraso</a>
            </div>
          </div>
        </div>
      </div>
