<link rel="stylesheet" href="<?php echo base_url(); ?>assets/pesquisa/jquery-ui.css">
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pesquisa/jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pesquisa/jquery-ui/jquery-ui.js"></script>	
        ...
        <div class="row">
            <div class="card white">
                <div class="card-content black-text">
                    ...
                    <div class="row" id="desconto" style="display: none;">
                        <div class="center input-field col s5 m5">
                            ...
                            <a id="linkbonificar"  href="<?php echo base_url("Cliente/bonificar/" . $this->uri->segment("3")); ?>">
                ...
                <div class="card-action center">
                    <a id="linkeditar" class="waves-effect waves-light btn" href="<?php echo base_url("Cliente/editar/" . ''); ?>"><i class="material-icons right">edit</i>Editar dados do cliente</a>
                </div>
            </div>
        </div>
    </div>
        ...
        $(function () {
            $("#busca").autocomplete({
                source: function (request, response) {
                    limpaCampos();
                    $.ajax({url: '<?php echo base_url(); ?>Cliente/consulta_cliente',
                ...
                focus: function (event, ui) {
                    ...
                    $("#cliente_idcliente").val(ui.item.id_cliente);
                    iddocliente = ui.item.id_cliente;
                    carregarDados();
                    return false;
                },
                ...
                return $("<li>")
                        .append("<a><b>Nome: </b>" + item.nome + "<br><b>CPF: </b>" + item.cpf + " -  ID:" + item.id_cliente + "</a><br>")
                        .appendTo(ul);
            };
            function carregarDados() {
                ...
                if (busca != "" && busca.length >= 2) {
                    $.ajax({
                        url: '<?php echo base_url(); ?>Cliente/consulta_cliente',
                        dataType: "json",
                        type: "POST",
                        data: {
                            acao: 'consulta',
                        ...
                        success: function (data) {
                            ...
                            $('#cliente_idcliente').val(data[0].id_cliente);
                            ...
                            document.getElementById("linkeditar").setAttribute('href', '<?php echo base_url("Cliente/editar/"); ?>/' + id_docliente);
                            document.getElementById("linkbonificar").setAttribute('href', '<?php echo base_url("Cliente/bonificar/"); ?>/' + id_docliente);
